	...
	<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
                ...
                <a href="home.php" style="float:right; color:#FFF; padding:10px;">
                	Trở lại trang chủ
                </a>
				<!-- END LOGO -->
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul>
				<li class="">
					...
					<a href="javascript:;" class="bgmn">
						Bài viết
					<span class="selected"></span>
					<span class="arrow open"></span>
					</a>
					<ul class="sub">
						<li class="active"><a class="" href="admin.php">Quản lý</a>
                        </li>
						<li><a class="" href="thembaiviet.php">Thêm mới</a>
                        </li>
					</ul>
				</li>
            <li class="has-sub active">
